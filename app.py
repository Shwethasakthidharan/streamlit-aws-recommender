...
# Specific Filtering for CPU and RAM
vcpu_options = sorted(filtered_df["vcpu"].unique())
selected_vcpu = st.selectbox("Exact CPU Cores (vCPU)", ["Any"] + vcpu_options)
...
selected_ram = st.selectbox("Exact RAM (GiB)", ["Any"] + ram_options)
